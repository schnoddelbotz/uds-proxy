...
//
// From: https://github.com/hashicorp/go-retryablehttp/blob/master/client.go
//
...
func NewClient() *Client {
	return &Client{
		HTTPClient:   &http.Client{}, //cleanhttp.DefaultClient(),
...
// NewClientWithClient creates a new Client based on user-supplied http.Client.
func NewClientWithClient(client *http.Client) *Client {
	return &Client{
		HTTPClient:   client,
		Logger:       nil, //log.New(os.Stderr, "", log.LstdFlags),
		RetryWaitMin: defaultRetryWaitMin,
		RetryWaitMax: defaultRetryWaitMax,
		RetryMax:     defaultRetryMax,
		CheckRetry:   DefaultRetryPolicy,
